...
class Ui_Config(object):
    def setupUi(self, Config):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -376, 450, 890))
        ...
        self.Label_APISecretSetting = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.Label_APISecretSetting.setGeometry(QtCore.QRect(20, 60, 141, 20))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(16)
        font.setUnderline(False)
        self.Label_APISecretSetting.setFont(font)
        self.Label_APISecretSetting.setObjectName("Label_APISecretSetting")
    ...
    def retranslateUi(self, Config):
        ...
        self.Label_APISecretSetting.setText(_translate("Config", "API密钥设置："))
