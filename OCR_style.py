...
class Ui_OCR_Window(object):
    def setupUi(self, OCR_Window):
        ...
        self.confirmHotKeyButton = QtWidgets.QPushButton(self.centralwidget)
        self.confirmHotKeyButton.setGeometry(QtCore.QRect(421, 30, 21, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
        font.setPointSize(11)
        ...
        self.cancelHotKeyButton = QtWidgets.QPushButton(self.centralwidget)
        self.cancelHotKeyButton.setGeometry(QtCore.QRect(440, 30, 21, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei UI")
    ...
    def retranslateUi(self, OCR_Window):
        ...
        self.OCRKeyEdit.setToolTip(_translate("OCR_Window", "摁下快捷键以键入"))
        self.confirmHotKeyButton.setToolTip(_translate("OCR_Window", "<html><head/><body><p>确认更改快捷键</p></body></html>"))
        self.confirmHotKeyButton.setText(_translate("OCR_Window", "√"))
