...
class Ui_OCR_Window(object):
    def setupUi(self, OCR_Window):
        ...
        self.TransResult_2.setGeometry(QtCore.QRect(30, 260, 721, 71))
        font = QtGui.QFont()
        font.setFamily("思源黑体")
        font.setPointSize(18)
        ...
        self.TransResult_3.setGeometry(QtCore.QRect(30, 340, 721, 71))
        font = QtGui.QFont()
        font.setFamily("思源黑体")
        font.setPointSize(18)
        self.TransResult_3.setFont(font)
        self.TransResult_3.setObjectName("TransResult_3")
        self.TransResult_4 = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.TransResult_4.setGeometry(QtCore.QRect(30, 420, 721, 71))
        font = QtGui.QFont()
        font.setFamily("思源黑体")
        font.setPointSize(18)
        self.TransResult_4.setFont(font)
        self.TransResult_4.setObjectName("TransResult_4")
