...
class Ui_OCR_Window(object):
    def setupUi(self, OCR_Window):
        ...
        self.ChooseAreaButton.clicked.connect(OCR_Window.getScreenPos)
        self.OCRButton.clicked.connect(OCR_Window.getOCRText)
        OCR_Window.ocrHotkeyPressed.connect(OCR_Window.getOCRText)
        self.OCRResultTextEdit.focusOut.connect(OCR_Window.doAutoTrans)
        self.SplitChooseBox.currentTextChanged['QString'].connect(OCR_Window.updateSplitMode)
        self.OCRButtonPlus.clicked.connect(OCR_Window.appendOCRText)
        self.showDictWindowButton.clicked.connect(OCR_Window.showDictWindow)
        self.OCRResultTextEdit.selectedFinish.connect(OCR_Window.updateSelectionText)
        self.splitTextEdit.selectedFinish.connect(OCR_Window.updateSelectionText)
        self.OCRResultTextEdit.focusOut.connect(self.OCRResultTextEdit.clearSelection)
        self.splitTextEdit.focusOut.connect(self.splitTextEdit.clearSelection)
        self.autoDictCheckBox.clicked['bool'].connect(OCR_Window.updateAutoDictBool)
        self.autoTransCheckBox.clicked['bool'].connect(OCR_Window.updateAutoTransBool)
        self.doTransButton.clicked.connect(OCR_Window.updateResults)
